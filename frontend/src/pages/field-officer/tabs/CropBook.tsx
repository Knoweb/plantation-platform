            ...
            try {
                ...
                for (let i = 1; i <= lastDay; i++) {
                    ...
                    finalData.push({
                        ...
                        yieldPerAcreDay: (!isFuture && (yPerAcreDay > 0 || activeAcreageDay > 0)) ? yPerAcreDay.toFixed(2) : '',
                        yieldPerAcreTodate: (!isFuture && (yPerAcreToDate > 0 || permCasWtToDate > 0)) ? yPerAcreToDate.toFixed(2) : '',
